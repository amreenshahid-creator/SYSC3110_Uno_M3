...
for the previews milestone, Marc prepared the README, added JavaDocs, comments and completed the UML class diagram and the sequence diagrams. for current milestone, Marc worked on the AI player features for this milestone. He added the option to choose between human players and AI players, and he made sure the AI only plays legal cards. He also set up strategy so the AI makes moves that make sense within the context of game state. Marc also checked that the game still runs properly when playing with 1 human and 3 AI players. Marc updated the class diagrams and created the two required sequence diagrams: one for a human using a Flip card and one for the AI taking its turn.
